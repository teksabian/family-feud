# Survey Says — Pub Survey Game by Game Night Guild

*A Flask-powered Survey Says game for pub trivia nights. Teams join via QR codes, AI does the homework, and the database deletes itself when you're done.*
