...
*A Flask-powered Survey Says clone for pub trivia nights. Teams join via QR codes, AI does the homework, and the database deletes itself when you're done.*
...
*This is the dramatic, Survey Says-style answer reveal on a projector or TV. Skip this if you don't have a big screen.*
...
5. **Reveal answers one by one.** On the Board screen, tap each answer tile to flip it from blue (hidden) to gold (revealed). Classic Survey Says flip animation included.
